...
### 选宠页面
选择 3 只宝可梦，第一只为上场，其余两只为板凳智囊。

![选宠页面](docs/images/01-select.png)

### 对战界面
左侧对手/玩家状态卡 + 技能按钮，中间战斗画布，右侧实时战斗日志。

![对战界面](docs/images/02-battle.png)

### 回合结算
每回合过后 HP 条实时更新，Agent 决策过程全透明。

![回合后](docs/images/03-battle-turn.png)

### 战斗结束
弹出结算弹窗，显示胜负，支持再来一局。

![战斗结算](docs/images/04-result.png)
